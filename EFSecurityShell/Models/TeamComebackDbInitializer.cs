...
namespace TeamComeback_V2.Models
{
    public class TeamComebackDbInitializer : DropCreateDatabaseIfModelChanges<TeamComeback_V2Context>
    {
        protected override void Seed(TeamComeback_V2Context context)
        {
            ...
            defaultCourses.Add(new Course() { Name = "L1-Escape This", Terms = Terms.Fall, Year = "2019", Day = DayOfWeek.Monday, Time = "10:20 am - 10:40 am", InstructorName = "Zoe Doe", Cost = 19.99, Description = "Play World Game" });
            defaultCourses.Add(new Course() { Name = "L1-Presentation Group", Terms = Terms.Fall, Year = "2019", Day = DayOfWeek.Monday, Time = "10:40 am - 10:00 am", InstructorName = "Dave Doe", Cost = 19.99, Description = "Play World Game" });
            ...
            defaultCourses.Add(new Course() { Name = "AL-Slow Road to Better", Terms = Terms.Fall, Year = "2018", Day = DayOfWeek.Tuesday, Time = "10:40 am - 11:00 am", InstructorName = "Amy Doe", Cost = 15.99, Description = "Play World Game" });
